#ifndef MG3TR_SRC_WINDOW_INPUTCONSTANTS_HPP_INCLUDED
#define MG3TR_SRC_WINDOW_INPUTCONSTANTS_HPP_INCLUDED
...
#endif // MG3TR_SRC_WINDOW_INPUTCONSTANTS_HPP_INCLUDED
